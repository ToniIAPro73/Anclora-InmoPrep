    ...
    <div className="space-y-5">
      <section className="app-card rounded-md p-5">
        <div className="flex flex-col gap-3 lg:flex-row lg:items-center lg:justify-between">
          ...
          <div className="app-soft inline-flex items-center gap-2 rounded-md px-4 py-3 font-semibold">
            <TimerReset className="h-5 w-5 text-harbor" />
            45:00
          </div>
        </div>
        <button
          className="app-control focus-ring mt-4 rounded-md px-3 py-2 text-sm font-medium"

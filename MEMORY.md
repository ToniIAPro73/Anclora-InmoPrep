...
> Generated: 2026-07-24 11:42:16  
> Total memories: **51**  
> Breakdown: instruction: 2, fact: 3, decision: 5, context: 1, event: 25, learning: 4, observation: 4, artifact: 1, error: 6
...
### User activated caveman mode in Codex; use caveman ...

User activated caveman mode in Codex; use caveman full terse style until user says stop caveman or normal mode.

*Confidence: 1 | Status: active | Created: 2026-07-20T07:13:35*
...
### Cierre promocion completa SyncXML docs/manuales: c...

Cierre promocion completa SyncXML docs/manuales: commit a04d3f7 docs(syncxml): localize readme and refresh manuals pusheado a development y promovido a staging eabfbbb, production f07f07a y main 70e75da. Arboles equivalentes entre ramas permanentes, local=remoto en las 4 ramas, repo limpio en development.

*Confidence: 0.95 | Status: active | Created: 2026-07-20T07:49:09*
...
### Cierre promocion completa SyncXML: rama chore/code...

Cierre promocion completa SyncXML: rama chore/codex-manuals-repo-cleanup-review integrada en development y promovida development -> staging -> production -> main. Heads: development 58c72eb, staging 69071eb, production 39407d9, main 071c32f. Arboles equivalentes entre ramas permanentes, repo limpio en development, rama temporal borrada local y remoto.

*Confidence: 0.95 | Status: active | Created: 2026-07-20T07:16:10*
...
### Cierre parcial SyncXML docs: README raiz cambiado ...

Cierre parcial SyncXML docs: README raiz cambiado a español por defecto con selector a README.en.md y README.de.md; manuales ES/EN/DE reemplazan índice en tabla por toc-grid editorial; capturas manuales regeneradas desde app real con script scripts/capture-syncxml-manual-screenshots.mjs; HTML/PDF public/manuals regenerados. Validado: check:public-docs, eslint, git diff --check, pdfinfo 20 paginas cada PDF.

*Confidence: 0.95 | Status: active | Created: 2026-07-20T07:46:06*
...
### Anclora Impulso: tras merge del PR #56 en developm...

Anclora Impulso: tras merge del PR #56 en development, se promovio el contenido por el flujo development -> staging -> production -> master. Commits de promocion: staging fa93928, production f265c32, master ac68ab4. Las ramas locales y origin quedaron sincronizadas; se elimino la rama fix/codex-modal-scroll-close-localization local y remota.

*Confidence: 0.95 | Status: active | Created: 2026-07-24T06:15:03*
...
### Cierre promocion completa SyncXML pantallazos clar...

Cierre promocion completa SyncXML pantallazos claro/oscuro manuales: commit 016cb8d docs(syncxml): mix manual screenshots themes pusheado a development y promovido a staging 46aa38b, production 0cdc7fb y main 65824c7. Arboles remotos development/staging/production/main sincronizados y workspace limpio en development.

*Confidence: 1 | Status: active | Created: 2026-07-20T08:01:34*

### En Anclora SyncXML se actualizaron los pantallazos...

En Anclora SyncXML se actualizaron los pantallazos de los manuales en es/en/de para mezclar modo claro y modo oscuro: import/review/xml en claro y precheckin/dashboard en oscuro; se regeneraron los PDFs de los tres idiomas y se validaron check:public-docs, lint, git diff --check y pdfinfo con 20 paginas.

*Confidence: 1 | Status: active | Created: 2026-07-20T07:59:31*
...
### En Anclora Impulso PR #56, el build frontend de Gi...

En Anclora Impulso PR #56, el build frontend de GitHub Actions con Next.js 14 fallaba en Collecting page data con createContext is not a function cuando Server Components de auth importaban Button/Card de shadcn/Radix; se resolvio haciendo server-safe app/auth/error/page.tsx y app/auth/signup-success/page.tsx con markup nativo y Link. Commits e9a7075 y fc4a044; checks frontend pasaron.

*Confidence: 0.95 | Status: active | Created: 2026-07-24T06:10:17*
...
### In Anclora Impulso, workout equipment canonical va...

In Anclora Impulso, workout equipment canonical value is 'machine', not 'machines'; UI labels should be localized through typed workout-domain labels while API payloads stay canonical.

*Confidence: 0.95 | Status: active | Created: 2026-07-23T20:29:04*
